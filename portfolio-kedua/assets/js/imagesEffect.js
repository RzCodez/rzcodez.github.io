{
	...
	const hero_sec = document.querySelector(".main-page");
	...
	hero_sec.addEventListener("mousemove", (ev) => (mousePos = getMousePos(ev)));
	...
	class ImageTrail {
		constructor() {
			this.DOM = { content: document.querySelector(".main-page") };
			this.images = [];
